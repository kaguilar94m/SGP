...
$conexion=mysql_connect("localhost","root","racb1994");
mysql_select_db("diaza", $conexion);
     ...
     <div class="accordion">
      ...
      <div class="accordion-group">
       ...
       <div id="c-tables" class="accordion-body collapse in"><div class="accordion-inner">
        <a href="table_static.php" class="sbtn sbtn-default">Static Tables <span class="label label-soft">2</span></a>
     ...
     <tbody>
      ...
      <?php 
        ...
        while($fila=mysql_fetch_array($resultado))
        {
          ...
          echo "<td> $fila[codigo] </td> <td> $fila[nombre] </td> <td> $fila[tipo] </td>";



           echo "<td class='center'> <input onClick=\"window.location.href='link.php';\" type='image' src='Imagenes/editar.png' style='max-width: 25px;'> &nbsp;&nbsp;&nbsp;
          <input onClick=\"if(confirm('Se eliminará este registro')) window.location.href='eliminarUsuario.php';\" type='image' src='Imagenes/eliminar.png' style='max-width: 25px;'> </td> ";
