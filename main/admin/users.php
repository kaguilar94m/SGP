<?php
  ...
  if(!isset($_SESSION["userData"]) or $_SESSION["userData"]->getPerfil() != "Administrador"){
   ...
   $(document).ready(function() {
    ...
    "aoColumnDefs": [
      ...
      {"aTargets":[5], "mRender" : function(data, type, full){
        return "<a href='editPermisos.php?id="+full.email+"' class = 'btn btn-soft btn-sm'><i class='icon icon-edit'></i></a>"
      }}
    ]
    }); 
